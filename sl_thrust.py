...
Thrust object for the game "Spacelancer".
'''
from sl_moveable_object import MoveableObject
from sl_config import SHIP_INFO

class Thrust(MoveableObject):
    '''
    Thrust object representation, derived from MoveableObject.
    ----------
    Parameters
        image: str
